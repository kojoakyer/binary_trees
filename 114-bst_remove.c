 ...
 * @root: A pointer to the root node of BST to search.
 *
 ...
 * @node: A pointer to the node  delete from the BST.
 *
 ...
 * Return: A pointer to the new root node after deletion.
 *
 * Description: If the node that will be deleted has two children, it
